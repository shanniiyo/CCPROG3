...
/**
 * StoreGUI.java
 * The main frame of the store management application.
 * This class initializes the application's core components, such as the inventory
 * and loyalty card data. It uses a CardLayout to manage and switch between
 * different user interface panels (e.g., Main Menu, Catalog, Cart, Checkout).
 * It acts as the central controller for the application's GUI flow.
 *
