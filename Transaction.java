/**
 * Transaction.java
 * Manages the entire business logic of a single purchase.
 * It takes a Customer and a Cart, calculates the subtotal, applies discounts
 * (senior and loyalty), computes VAT, and finalizes the payment to generate a receipt.
 * This class serves as the core engine for processing a sale.
 *
